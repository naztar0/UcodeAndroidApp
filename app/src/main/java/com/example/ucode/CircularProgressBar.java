...
public class CircularProgressBar extends View {
    ...
    private boolean mSubstrate = false;         // Full circle layer under progress
    private int mSubstrateColor = Color.GRAY;    // Full circle layer under progress color
    ...
    private void drawOutlineArc(Canvas canvas) {
        ...
        if (mSubstrate) {
            mPaint.setColor(mSubstrateColor);
            mPaint.setStrokeWidth(mStrokeWidth);
            mPaint.setAntiAlias(true);
            mPaint.setStrokeCap(Paint.Cap.BUTT);
            mPaint.setStyle(Paint.Style.STROKE);
            canvas.drawArc(outerOval, mStartAngle, 360, false, mPaint);
        }
    ...
    public void setSubstrateColor(int color) {
        mSubstrateColor = color;
        invalidate();
    }
    ...
    public void showSubstrate(boolean show) {
        mSubstrate = show;
        invalidate();
    }
